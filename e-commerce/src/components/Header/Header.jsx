...
export const Navbar = () => {
  ...
  return (
    <div className="relative w-full h-16 overflow-hidden justify-between bg-white">
      <div className=" py-2 sticky w-full h-16 overflow-hidden justify-between bg-white">
